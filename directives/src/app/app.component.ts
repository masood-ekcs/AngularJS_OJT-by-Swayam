...
export class AppComponent {
  ...
  display5Cards: any[] = this.employeeDetails.slice(0, 5);
  ...
  addNewEmployee() { // displays the Add New Employee form and hides the landing page buttons
    this.displayEmpForm = true;
    this.displayButtons = false;
  }

  // capture the values from the input fields
  addNewEmployeeDetails(empName: string, empImage: string, empTitle: string): boolean {
